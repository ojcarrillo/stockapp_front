...
export class PaginatorDirective implements DoCheck, AfterViewInit {
    ...
    constructor(
        ...
        /* this.matPag._intl.getRangeLabel = (page: number, pageSize: number, length: number): string => {
             ...
             const endIndex = startIndex < length ?
                 ...
                 startIndex + pageSize;
             return length > 0 ? 'Showing ' + (startIndex + 1) + ' – ' + endIndex + ' of ' + length +
                  ' records' : 'Showing 0 – 0 of 0 records';
         }; */
    ...
    private createButton(index: string, pageIndex: number): MatButton {
        ...
        this.renderer.setAttribute(linkBtn, 'class', 'custom-paginator-page btn');
        ...
        switch (index) {
            case `${pageIndex}`:
                ...
                this.renderer.addClass(linkBtn, 'btn-info');
                break;
