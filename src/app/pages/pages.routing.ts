...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'ver-factura', component: VerFacturaComponent, data: { parent: 'Proveedores', titulo: 'Ver Factura de Compra' } },
            ...
            { path: 'devoluciones', component: DevolucionesComponent, data: { parent: 'Ventas', titulo: 'Devolución de Artículos' } },
